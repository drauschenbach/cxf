...
public class WSDLToRust {


    public static final String DEFAULT_FRONTEND_NAME = "reqwest";
    ...
    public WSDLToRust(String[] pargs) {
        args = pargs;
    }
    ...
    public static void main(String[] pargs) {
        ...
        WSDLToRust w2j = new WSDLToRust(pargs);
        try {
            ...
            System.err.println();
            System.err.println("WSDLToRust Error: " + ex.getMessage());
            System.err.println();
            if (w2j.isVerbose()) {
                ex.printStackTrace();
            }
